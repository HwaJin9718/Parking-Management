                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                             <c:if test="${member_rating eq 'admin'}">
                                 <a href="./NoticeUpdateEvent.so?notice_code=${noticeDTO.notice_code}" class="btn btn-warning">수정</a>
                          		  <a href="./NoticeDeleteView.so?notice_code=${noticeDTO.notice_code}" class="btn btn-danger">삭제</a>
                            </c:if>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <a href="./NoticeSelectEvent.so" class="btn btn-primary btn-block">이벤트 목록으로 돌아가기</a>
                            </div>
                        </div>
                    </div>
                </div>
