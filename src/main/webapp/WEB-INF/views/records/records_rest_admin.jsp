...
<head>
<meta charset="UTF-8">
<title>주차 기록 (admin)</title>
<link rel="stylesheet" type="text/css" href="./react/records/admin/css/main.db62923b.css">
...
<script src="./react/records/admin/js/453.80efc53e.chunk.js"></script>
<script src="./react/records/admin/js/main.f79206a5.js"></script>
