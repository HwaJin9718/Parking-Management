					...
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center">
								<a
									href="./FaqAnswerUpdate?faq_answer_code=${noticeDTO.faq_answer_code}"
									class="btn btn-warning">수정</a> <a
									href="./FaqAnswerDelete?notice_code=${noticeDTO.faq_answer_code}"
									class="btn btn-danger">삭제</a>
							</div>
							<div class="row mt-4">
								<div class="col-md-12">
									<a href="./FaqSelect" class="btn btn-primary btn-block">게시판
										홈으로 돌아가기</a>
								</div>
							</div>
						</div>
