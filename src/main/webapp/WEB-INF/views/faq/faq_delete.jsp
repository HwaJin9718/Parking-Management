					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group row">
								<label for="faq_code" class="ml-sm-3 col-form-label">삭제할
									게시글 번호</label>
								<div class="ml-sm-3">
									<input type="text" name="faq_code" id="faq_code"
										class="form-control form-control-sm bg-white">
								</div>
							</div>
							<div class="form-group">
								<button type="button" class="btn btn-secondary"
									onclick="deleteFaq(document.getElementById('faq_code').value)">삭제</button>
