		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 text-right">
					<button onclick="goToAddComment()" class="btn btn-primary">댓글
						작성</button>
				</div>
			</div>
		</div>
								...
								<tbody>
									<c:forEach var="list" items="${list}">
										<tr class="text-center">
											...
											<td><fmt:formatDate value="${list.comment_date}"
													pattern="yyyy-MM-dd HH:mm" /></td>
											<td><a
												href="./CommentUpdate?comment_code=${list.comment_code}"
												class="btn btn-warning">수정</a>
												<button onclick="deleteComment(${list.comment_code})"
