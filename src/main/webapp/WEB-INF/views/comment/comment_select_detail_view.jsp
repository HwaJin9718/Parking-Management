					...
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center">
								<a
									href="./CommentUpdate?comment_code=${commentDTO.comment_code}"
									class="btn btn-warning">수정</a> <a
									href="./CommentDelete?comment_code=${commentDTO.comment_code}"
									class="btn btn-danger">삭제</a>
							</div>
							<div class="row mt-4">
								<div class="col-md-12">
									<a href="./CommentSelect" class="btn btn-primary btn-block">전체
										조회 목록으로 돌아가기</a>
								</div>
							</div>
						</div>
