            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="./CalculateFee" method="post" id="sign_ticket">
                                <fieldset>
                                    <div class="form-group row">
                                        ...
                                        <div class="ml-sm-3">
                                            <input type="text" name="member_code" id="member_code"
                                                class="form-control form-control-sm" value="${sessionScope.customMemberDetails.memberCode}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        
                                        <input type="hidden" name="records_code" id="records_code" value="${param.records_code}" />
                                        <input type="hidden" name="parking_code" id="parking_code" value="${param.parking_code}" />
